...
import {concatMap, forkJoin, fromEvent, mergeMap, Observable, of, Subscription} from "rxjs";
...
export class ConcatMapComponent implements AfterViewInit ,OnDestroy {
  public obsResponse:string[]=[];
  public concatMapListHeader:string = 'MergeMap Response';
  public concatMapSyntax = `
